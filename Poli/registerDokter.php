...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="font-weight: bold; font-size: 32px;">Register Dokter</div>
                <div class="card-body">
                    <form method="POST" action="index.php?page=registerDokter">
                        ...
                        <div class="form-group">
                            ...
                            <input type="alamat" name="alamat" class="form-control" required placeholder="Masukkan alamat">
                        </div>
                        <div class="form-group">
                            <label for="no_hp">No HP</label>
                            <input type="no_hp" name="no_hp" class="form-control" required placeholder="Masukkan nomor hp">
                        </div>
                        <div class="form-group">
